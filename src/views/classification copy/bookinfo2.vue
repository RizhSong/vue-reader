<template>
  <div class="list">
      ...
      <div class="pageHS" v-show="pageshow">
        ...
        <div class="pageSH">
          ...
          <div class="chapter" v-for="(item,idx) in Catalog" :key="idx">
            <router-link :to="'/read/'+item.link" tag="div">
              {{idx + 1}}.{{item.title}}
            </router-link>
          </div>
        </div>
    ...
    <div class="authorBooklist">
           <!-- <div > -->
             <router-link :to="'/bookinfo1/'+item._id+'/'+item.author" tag="div" class="authorBooklist1" v-for="item in authorBooklist" :key="item.cover">
             <div class="authorBooklist2">
               <img  class="img2" :src="`http://statics.zhuishushenqi.com${item.cover}`" ><br>
             </div>
    ...
    <div class="authorBooklist">
           <!-- <div > -->
             <router-link :to="'/bookinfo1/'+item._id+'/'+item.author" tag="div" class="authorBooklist1" v-for="item in recommendBooklist" :key="item.cover">
             <div class="authorBooklist2">
               <img  class="img2" :src="`http://statics.zhuishushenqi.com${item.cover}`" ><br>
             </div>
      ...
      <div>
        <div><h3>图书信息</h3>
        </div>{{bookinfo.copyrightInfo}}<div>
